...
export default function ProblemSolutionSection() {
    return (
      <section id="why-lucnt" className="py-16 md:py-24 bg-secondary/20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold font-accent mb-4">Tired of Content Chaos?</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Juggling different social platforms, each with its own rules and audience, is a drain.
              Generic content falls flat. Lucnt.space brings the focus you need.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div>
              <h3 className="text-2xl font-semibold font-accent mb-3 text-primary">The Lucnt Solution: AI-Powered Illumination</h3>
              <ul className="space-y-2 text-muted-foreground list-disc list-inside">
